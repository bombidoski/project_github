...
def get_filters():
    ...
    Returns:
        ...
        (str) day - particular name of  day of week to filter by, or "all" to apply no day filter
    """
    print('Hello! Let\'s explore some US bikeshare data!')
    # get user input for city (chicago, new york city, washington). HINT: Use a while loop to handle invalid inputs


    city = input("hi, would you like ot see data for Chicago, New York City or Washington: \n").lower()
    while city not in('chicago', 'new york city', 'washington'): #while loop to handle invalid inputs
        print("That's not a valid entry please try again\n")
        city = input("would you like ot see data for Chicago, New York City or Washington:   \n").lower()


    # get user input for month (all, january, february, ... , june)
    month = input("Which month would you like to analyze? Name one month, or type 'All'. Only first six months i.e January to June are available:   \n").lower()
    while month not in('january', 'febuary', 'march', 'april', 'may', 'june','all'): ##while loop to handle invalid inputs
    ...
    while day not in('monday', 'tuesday', 'wednesday', 'thursday', 'friday', 'saturday', 'sunday', 'all'): ##while loop to handle invalid inputs
        print('That\'s not a valid entry: please try again.\n')
